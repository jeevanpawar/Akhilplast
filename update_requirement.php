...
/*
    ...
    <br />
		<div class="hr"><center>Update Requirement</center></div>
        <div>
             ...
             <td>
              ...
              <table class="y_clients">
                ...
                <td><input id="rem" class="q_in2" name="remark" type="text" value="<?php echo $req[12];?>"/> </td></tr>
                 ...
                 <div class="addclients_p">
         <input name="p_add" value=" Update " type="submit" onClick="javascript:return validateMyForm();" />
