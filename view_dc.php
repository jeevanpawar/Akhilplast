...
<div id="container">
    ...
    <tr class="search_res">
    <td class="info" width="1070"> Delivery Challan Details</td>
    <td>
    <span>
    ...
    <a href="#" rel="popuprel" class="popup new">New</a>
		...
		echo "</td>";		
        echo "<td width='80'>";
		echo "<a href='?c_id1=$c_row[0]' onclick='return confirmSubmit()' class='print'></a>&nbsp;<a href='view_Requirement.php?id=$c_row[0]' class='print'>Create DC</a>";
		echo "</td>";
		echo "</tr>";
		}
