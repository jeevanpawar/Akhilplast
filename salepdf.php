...
$qry="select * from po where work_date >='".$date1."' and work_date <='".$date2."'";
$res=mysql_query($qry);
?>
<html>
<head>
...
<div class="de">SALES DETAILS</div>
...
<th width="25%">Dispatch Through</th>
</tr>
</thead>
<tbody>
<?php
...
{
	$q="select * from clients where c_id='$row[1]'";
	$r=mysql_query($q);
